...
const LavacordNodeLink = require('./LavacordLinkNode')
const SearchResponse = require('./model/SearchResponse')
const LavacordLinkPlayer = require('./LavacordLinkPlayer')
 ...
 */
class LavacordLinkerManager extends EventEmitter {
    /**
     * The constructor of {@link LavacordLinkerManager}
     * @param {Client} client Discord client
     * @param {LavacordNodeLink[]} nodes A Array of options that the {@link LavacordLinkerManager} will connect
    ...
    constructor(client, nodes, options = {}) {
        ...
        this.user = null // Discord Client user id
        this.shards = options.shards || 0 // Total of Discord Client shards

        this.Player = options.Player || LavacordLinkPlayer // A instance of Gorilink player used to create new players
     ...
     * @returns {LavacordNodeLink} Lavalink node
     */
    createNode(options) {
        const node = new LavacordNodeLink(this, options)
     ...
     * @returns {LavacordLinkPlayer} Guild player
     */
    join(data = {}, options = {}) {
     ...
     * @returns {LavacordLinkPlayer} Deleted player
     */
    leave(guild) {
        this.sendWS({
            op: 4,
    ...
    /**
     * Creates a instance of {@link LavacordLinkPlayer}
     ...
     * @param {LavacordNodeLink} node The node to send the request
...
module.exports = LavacordLinkerManager