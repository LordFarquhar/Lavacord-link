...
class GorilinkPlayer extends EventEmitter {
     ...
     * @param {LavacordLinkNode} node Your node instance
     * @param {Object} options Player options
     * @param {LavacordLinkerManager} manager Your LavacordLinkerManager instance
     */
    constructor(node, options, manager) {
        super()

        /**
         * {@link LavacordLinkerManager} instance
         */
        this.manager = manager

        /**
         * {@link LavacordLinkNode} instance
         */
        this.node = node
    ...
    getEvent(data) {
        const events = {
            'TrackStartEvent': function() {
                 ...
                 * @event LavacordLinkerManager#trackStart
            ...
            'TrackEndEvent': function() {
                 ...
                 * @event LavacordLinkerManager#trackEnd
                 * @property {LavacordLinkerManager} player - Player ended the track
                 * @property {Object} track - Track data
                 */
                if (this.track && this.looped == 1) {
                    ...
                    if (['REPLACED', 'FINISHED', 'STOPPED'].includes(data.reason)) {
                         ...
                         * @event LavacordLinkerManager#queueEnd
                         * @property {LavacordLinkerManager} player - Player where the queue ended
                         */
            ...
            'TrackStuckEvent': function() {
                this.queue.shift()
                     ...
                     * @event LavacordLinkerManager#trackStuck
            ...
            'TrackExceptionEvent': function() {
                this.queue.shift()
                     ...
                     * @event LavacordLinkerManager#trackError
            ...
            'WebSocketClosedEvent': function() {
                ...
                /**
                 * Emitted when events TrackStuckEvent comes from Lavalink node
                 * @event LavacordLinkerManager#socketClosed
